...
export class ConsentTreatmentFormComponent {
  ...
  public IMAGE_PREVISUALIZA_SIGNATURE_ANAYST_CREATED: any =
  ...
  public IMAGE_PREVISUALIZA_SIGNATURE_PARENT_CREATED: any =
    'assets/img/user-06.jpg';
  ...
  loadFile($event: any) {
    ...
    reader.onloadend = () =>
      (this.IMAGE_PREVISUALIZA_SIGNATURE_ANAYST = reader.result);
  }
  ...
  loadFile1($event: any) {
    ...
    reader2.onloadend = () =>
      (this.IMAGE_PREVISUALIZA_SIGNATURE_PARENT = reader2.result);
  }
