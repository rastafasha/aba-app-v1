    ...
    this.bipService
      ...
      .subscribe((resp) => {
        ...
        this.caregivers_training_goals =
          resp.bip.family_envolment?.[0]?.caregivers_training_goals;
        ...
        this.rbt_training_goals =
          resp.bip.monitoring_evalutating?.[0]?.rbt_training_goals;
        ...
        this.discharge_plan =
          resp.bip.generalization_training?.[0]?.discharge_plan;
        this.transition_fading_plans =
          resp.bip.generalization_training?.[0]?.transition_fading_plans;
        ...
        this.caregiver_requirements_for_prevention_of_crisis =
          resp.bip.crisis_plan?.[0]?.caregiver_requirements_for_prevention_of_crisis;
        ...
        this.other = this.risk_added?.[0]?.other;
        ...
        this.plan_homicidality =
          this.homicidality_added?.[0]?.plan_homicidality;
        this.means_homicidality =
          this.homicidality_added?.[0]?.means_homicidality;
        ...
        this.recomendation_lists =
          resp.bip.de_escalation_technique?.[0]?.recomendation_lists;
        ...
        this.analyst_signature =
          resp.bip.consent_to_treatment[0].analyst_signature;
        this.parent_guardian_signature =
          resp.bip.consent_to_treatment[0].parent_guardian_signature;
